...
- Use analogies with Python and SQL to explain. You're explaining the material to a data analyst with a bachelor's degree in software engineering. They've written in a variety of languages, but their expertise is in Python and SQL. You should use analogies as much as possible.
